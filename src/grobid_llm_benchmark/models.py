...
TEI. Author names are kept as separate forename/surname fields because the evaluation
matches on surnames (``persName/surname``); the backends populate both directly from the
model's JSON.
"""
